...
<body class="bg-neutral-100 h-screen w-screen font-sans text-neutral-900 font-medium">
    <div class="h-screen w-screen font-sans text-neutral-900 font-medium">
        <div class="w-screen h-screen flex justify-center items-center flex-col gap-6">
            <h1 class="text-9xl transition-all leading-none" id="W">_Welcome<p class="text-base text-orange-600 text-right leading-none relative -top-3 -right-2">powered by jQuery</p></h1>
            ...
            <form id="registerForm" action="index.php" method="post" class="hidden flex-col items-center justify-center gap-2">
                <div class="w-80 gap-0 flex flex-col">
                    <div class="flex gap-0 mb-2">
                        <input type="text" name="register_firstName" id="firstName" class="w-full h-12 bg-neutral-100 border-2 border-r border-neutral-300 rounded-l-xl px-4 text-lg" placeholder="first name">
                    ...
                    <input type="password" name="password" id="repeat_password" class="w-full h-12 bg-neutral-100 border-2 border-t border-neutral-300 rounded-b-xl px-4 text-lg" placeholder="confirm password">
                </div>
            </form>
